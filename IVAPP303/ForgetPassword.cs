...
namespace IVAPP303
{
    ...
    public class ForgetPassword : AppCompatActivity, IOnClickListener, IOnCompleteListener
    {
        ...
        public void OnComplete(Task task)
        {
            ...
            {
                Snackbar snackbar = Snackbar.Make(activity_forget, "Error", Snackbar.LengthShort);
                snackbar.Show();
            }
            else
            {
                Snackbar snackbar = Snackbar.Make(activity_forget, "Email de restablecimiento enviado a: " + input_email.Text, Snackbar.LengthShort);
                snackbar.Show();
            }
        }
    }
